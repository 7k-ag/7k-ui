...
>(({ className, boxClassName, ...props }, ref) => (
  ...
  >
    <span
      className={tw(
        "transition-all absolute inset-0 h-full w-full rotate-45 shrink-0 rounded-md border border-skin-base group-hover:border-iris-60 group-focus-visible:ring-1 group-data-[state=checked]:bg-iris-100 group-data-[state=checked]:border-transparent",
        boxClassName,
      )}
    ></span>
